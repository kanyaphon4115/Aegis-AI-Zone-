...
ระบบสแกนกราฟ, แชต และข้อมูลตลาดเรียก Anthropic จาก Backend เท่านั้น เพื่อให้ API key ไม่ถูกส่งไปหน้าเว็บ ตั้งค่า `ANTHROPIC_API_KEY` ใน Render Web Service; หากไม่มีค่านี้ endpoint ที่ต้องใช้ AI จะตอบ `503` และไม่สร้างผลลัพธ์จำลอง
